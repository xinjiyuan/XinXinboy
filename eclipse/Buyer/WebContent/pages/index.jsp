...
<title>无标题文档</title>
<script type="text/javascript" src="http://localhost:8081/Buyer/js/jquery.js"></script>
<link rel="stylesheet" type="text/css" href="http://localhost:8081/Buyer/css/bootstrap.css">
<link rel="stylesheet" type="text/css" href="http://localhost:8081/Buyer/css/muke.css">
<script type="text/javascript" src="http://localhost:8081/Buyer/js/jquery.SuperSlide.2.1.1.js"></script>
</head>

<body class="backg_huibai" style="">
	...
	<div class="width100 float_l height80 line_hei80">
        ...
        <div class="float_l">
            <div class="float_l margin_l20">
                <img src="http://localhost:8081/Buyer/images/uiz1.png">
            </div>
            <div class="float_l">
        ...
        <div class="float_r">
            <div class="float_l top_input">
                ...
                <img class="img_sousuo bianshou" src="http://localhost:8081/Buyer/images/uiz4.png">
            </div>
            <div class="float_l margin_l20">
                <img src="http://localhost:8081/Buyer/images/uiz5.png">
            </div>
            <div class="float_l margin_l40">
                <img src="http://localhost:8081/Buyer/images/uiz3.png">
            </div>
            <div class="float_l margin_l35">
                <img src="http://localhost:8081/Buyer/images/uiz6.png">
            </div>
            <div class="float_l margin_l30 margin_r40">
                <!--img src="http://localhost:8081/Buyer/images/uiz2.png"-->
            <c:choose>
			<c:when test="${skip}">
				<img src="http://localhost:8081/Buyer/images/smile.png"> ${msg}
			</c:when>
			<c:otherwise>
			<a href="<c:url value='http://localhost:8081/Buyer/pages/Login.jsp'/>"><img src="http://localhost:8081/Buyer/images/re.png"> 注册</a>
      		<a href="<c:url value='http://localhost:8081/Buyer/pages/Login.jsp'/>"><img src="http://localhost:8081/Buyer/images/smile.png"> 登录</a>
			</c:otherwise>
		</c:choose>
            </div>
        </div>
	...
	<div class="width_1200 margin_auto">
    	<div class="width100 float_l height460 posi_relative">
        	<div class="width100 float_l">
                <div class="focusBox">
                    <div class="tempWrap" style="overflow:hidden; position:relative; width:1200px"><ul class="pic" style="width: 2400px; left: -1200px; position: relative; overflow: hidden; padding: 0px; margin: 0px;">
                        <li style="float: left; width: 1200px;"><a><img src="http://localhost:8081/Buyer/images/uiz21.jpg"></a></li>
                        <li style="float: left; width: 1200px;"><a><img src="http://localhost:8081/Buyer/images/uiz20.jpg"></a></li>
                    </ul></div>
            ...
            <div class="width_224 float_l height460 posi_absolute backg_jqian padding_t5 bianshou">
            	<div class="width100 float_l tab_qiehuan ">
                	<div class="width100 float_l text_c height64 line_hei64 color_white bianhuabeijing backg_jqian padding_lr20" style="background-color: rgb(169, 170, 174);">
                        <div class="width100 float_l text_l height64 line_hei64 color_white border_b_baise fon_siz16">
                            <span>前端开发</span>
                            <span class="float_r">&gt;</span>
                        </div>
                    </div>
                    <div class="width_700 float_l lunbofenlei dis_none img_backg15" style="display: none;">
                ...
                <div class="width100 float_l tab_qiehuan">
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg16" style="display: none;">
                    	<div class="width100 float_l padding40">
                        	<div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">分类目录</span>
                                <ul class="width100 ul_lis float_l">
                ...
                <div class="width100 float_l tab_qiehuan">
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg17" style="display: none;">
                    	<div class="width100 float_l padding40">
                        	<div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">分类目录</span>
                                <ul class="width100 ul_lis float_l">
                ...
                <div class="width100 float_l tab_qiehuan">
                    ...
                    <div class="width_700 float_l lunbofenlei dis_none img_backg18" style="display: none;">
                    	<div class="width100 float_l padding40">
                        	<div class="width100 float_l margin_b40">
                            	<span class="width100 color_shenred fon_siz16 float_l margin_b20">分类目录</span>
                                <ul class="width100 ul_lis float_l">
	...
	<div class="width_1200 margin_auto">
    	...
    	<div class="width100 float_l margin_b20">
            ...
            <div class="float_r bianshou">
            	<span><a href="<c:url value='http://localhost:8081/Buyer/SelectAllBookTypeServlet'/>">更多&gt;</a></span>
            </div>
        </div>
        ...
        <div class="width100 float_l">
        	<div class="width_224 height172 float_l margin_r20 border_shadow jingguoxianshi over_pos bianshou">
            	<div class="width100 float_l img_100 z_inx_1">
                	<img src="http://localhost:8081/Buyer/images/uiz7.jpg">
                </div>
                ...
                <div class="width100 float_l padding_lr20 height48 fon_siz12 line_hei48 z_inx_3 posi_relative backg_white">
                    <span class="float_l color_red">Hot</span>
...
<div class="width100 float_l padding_t30 height193">
	<div class="width_1200 margin_auto">
    	<div class="width100 float_l text_c margin_b30">
        	<a class="img_backg5" href="http://www.17sucai.com/preview/340858/2016-08-17/%E4%BB%BF%E6%85%95%E8%AF%BE%E9%A6%96%E9%A1%B5html%E6%BA%90%E7%A0%819/index.html#"></a>
            <a class="img_backg6 posi_relative wexinmaxianshi" href="http://www.17sucai.com/preview/340858/2016-08-17/%E4%BB%BF%E6%85%95%E8%AF%BE%E9%A6%96%E9%A1%B5html%E6%BA%90%E7%A0%819/index.html#"><i class="weixinweima dis_none"><img src="./idx-btm.png"></i></a>
            <a class="img_backg7" href="http://www.17sucai.com/preview/340858/2016-08-17/%E4%BB%BF%E6%85%95%E8%AF%BE%E9%A6%96%E9%A1%B5html%E6%BA%90%E7%A0%819/index.html#"></a>
            <a class="img_backg8" href="http://www.17sucai.com/preview/340858/2016-08-17/%E4%BB%BF%E6%85%95%E8%AF%BE%E9%A6%96%E9%A1%B5html%E6%BA%90%E7%A0%819/index.html#"></a>
        </div>
